...
//           {["TransactionID", "UserID", "TransactionAmount", "CurrencyType", "TransactionType", "TransactionStatus"].map((field) => (
//             <Input key={field} id={field} className="max-w-[300px]" placeholder={`Enter ${field}`} />
//           ))}
//         </div>
//         <div className="flex items-center gap-4">
//           <span>Minimum Risk</span>
//           <Slider defaultValue={[13]} max={100} step={1} onValueChange={(e) => setPredictedRisk(e[0])} />
//           <span className="font-bold">{predictedRisk}%</span>
//           <Button onClick={searchButtonClick}>Search</Button>
//         </div>
//       </div>
//       <Table>
//         <TableHeader>
//           {Object.keys(hardcodedData[0]).map((col) => (
